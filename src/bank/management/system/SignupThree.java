...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno)
    {
        ...
        JLabel card = new JLabel("Card Nummber:");
        card.setFont(new Font("Raleway",Font.BOLD,22));
        card.setBounds(100,300,200,30);
        add(card);
        
        JLabel number = new JLabel("XXXX-XXXX-XXXX-3184");
        ...
        c7 = new JCheckBox("HERE BY DECLARE THAT THE ABOVE ENTER DETAILS ARE CORRECT TO REST OF MY KNOWLEDGE");
